...
The introduce papers are in the top layer of this projecct


In this project, I used Qwen3 1.7b(https://modelscope.cn/models/Qwen/Qwen3-1.7B, Ali Team) for the experiment.
